...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
                                                    ...
                                                    TimeSpan.FromSeconds(request.MaxAge.Value)))
        {
            ...
            // var d = Request.PathBase + Request.Path + QueryString.Create(
            ...
            // return Ok(d);
            //then change to ~/login
            // return Redirect("https://localhost:44465/login" + QueryString.Create(
            //     Request.HasFormContentType ? Request.Form.ToList() : Request.Query.ToList()));
            //
            // return Challenge(
            //     authenticationSchemes: IdentityConstants.ApplicationScheme,
    ...
    //  [ActionName(nameof(Logout)), HttpPost("~/connect/logout"), HttpGet("~/connect/logout"), ValidateAntiForgeryToken]
    [Authorize]
    [HttpGet("~/connect/logout")]
    ...
    public async Task<IActionResult> Exchange()
    {
        ...
        if (request.IsAuthorizationCodeGrantType() || request.IsRefreshTokenGrantType())
        {
            ...
            //not working
            //principal.Claims.Append(new Claim("test", "VANYA"));
